...
Customer::Customer(std::string_view surname, std::string_view name, std::string_view street,
                   int streetNumber, std::string_view city)
    : m_surname{surname}, m_name{name}, m_street{street}, m_streetNumber{streetNumber},
      m_city{city} {}
