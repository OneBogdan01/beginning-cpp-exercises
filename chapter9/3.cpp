...
void print_data(const double data[], std::size_t count = 1, std::string_view title = "Data Values",
...
void print_data(const double data[], std::size_t count, std::string_view title, unsigned width,
                unsigned perLine) {
